...
date: 2017-06-15T05:46:39+10:00
comments: true
categories:
  - Git
...
![Initial Commit Structure](/images/2017/06/15/HowToSquashCommits_image1.png)
...
![Interactive Rebasing](/images/2017/06/15/HowToSquashCommits_image2.png)
...
![Selecting comments](/images/2017/06/15/HowToSquashCommits_image3.png)

Now Git will continue rebasing and it will squash all commits as selected in the previous step.

![Git rebase](/images/2017/06/15/HowToSquashCommits_image4.png)

If we look at commit history, we can see that commits are now squashed to single commit.

![Squashed Result](/images/2017/06/15/HowToSquashCommits_image5.png)