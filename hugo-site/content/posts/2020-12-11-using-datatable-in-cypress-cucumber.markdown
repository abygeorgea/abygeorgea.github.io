...
slug: "using-datatable-in-cypress-cucumber"
date: 2020-12-11T14:03:27+11:00
comments: true
categories:
  - Cypress
  - Cucumber
...
In the previous post [here](/blog/2020/12/09/writing-cypress-tests-in-bdd-format), we saw how to use cucumber along with Cypress. The demo scenario we saw was a basic example. Now let us look into how we can use datartable in cypress cucumber. 
...
![Result](/images/2020/12/11/datatable.png)
![Result](/images/2020/12/11/DOM.png)
