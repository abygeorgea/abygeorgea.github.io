...
date: 2022-02-01 06:46:12 +1000
comments: true
categories: [ReadyAPI, SoapUI]
keywords: [ReadyAPI, SoapUI, DataSource, Property Transfer, Conditional GoTo]
description: How to use Datasource loop and property Transfer in ReadyAPI
---

In my previous post [here]({{site.root}}blog/2022/01/19/readyapi-getting-started-with-readyapi/), I mentioned how to do a basic functional test. Sometimes, we might have to do complex flows where we need to call multiple APIs and also iterate the tests with various sets of data.
...
![Result]({{site.images_dir}}/2022/02/01/1_add_to_testcase.png)
...
![Result]({{site.images_dir}}/2022/02/01/2_add_to_testcase.png)
...
![Result]({{site.images_dir}}/2022/02/01/3_rename.png)
...
![Result]({{site.images_dir}}/2022/02/01/4_add_propertyTransfer.png)
...
![Result]({{site.images_dir}}/2022/02/01/5_transfer.png)
...
![Result]({{site.images_dir}}/2022/02/01/6_datasource.png)
...
![Result]({{site.images_dir}}/2022/02/01/7_datasourceloop.png)
...
![Result]({{site.images_dir}}/2022/02/01/8_transactionlog.png)
...
![Result]({{site.images_dir}}/2022/02/01/9_conditionalGoTo.png)
...
![Result]({{site.images_dir}}/2022/02/01/10_Results.png)