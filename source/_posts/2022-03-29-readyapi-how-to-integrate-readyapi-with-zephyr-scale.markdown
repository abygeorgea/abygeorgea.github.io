...
date: 2022-03-29 06:41:00 +1000
comments: true
categories: [ReadyAPI, SoapUI, Zephyr]
keywords: [ReadyAPI, SoapUI, Zephyr Scale, Integration, GroovyScripting]
...
![Result]({{site.images_dir}}/2022/03/29/1_ZephyrIntegration.png)
...
![Result]({{site.images_dir}}/2022/03/29/2_ZephyrIntegration.png)
