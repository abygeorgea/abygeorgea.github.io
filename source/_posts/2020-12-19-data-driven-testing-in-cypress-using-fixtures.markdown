...
date: 2020-12-19 11:10:44 +1100
comments: true
categories: [Cypress]
keywords: [Cypress, Data driven testing, Fixtures]
description: How to do data driven testing in Cypress
---

In the previous post [here]({{site.root}}blog/2020/12/19/reading-external-files-in-cypress-using-readfile) we saw how to read external files in Cypress using cy.readFile. Cypress also provides another way to read files. In this post, I will show how to Fixtures to do data driven testing in Cypress. 
...
![Fixture-ResultImage]({{site.images_dir}}/2020/12/19/Fixture-Result.png)
