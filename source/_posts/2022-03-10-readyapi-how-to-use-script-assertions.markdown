...
date: 2022-03-10 06:40:30 +1000
comments: true
categories: [ReadyAPI, SoapUI]
keywords: [ReadyAPI, SoapUI, Groovy Scripting, Script Assertion]
description: How to use script assertion in ReadyAPI
---


In the previous blog post [here]({{site.root}}blog/2022/01/19/readyapi-getting-started-with-readyapi/) and [here]({{site.root}}blog/2022/02/01/readyapi-how-to-make-full-use-of-readyapi-features/),  we saw how to create a functional test case and add assertions to validate the result.
...
![Result]({{site.images_dir}}/2022/03/10/1_ScriptAssertion.png)
...
![Result]({{site.images_dir}}/2022/03/10/2_assertionPassed.png)
...
![Result]({{site.images_dir}}/2022/03/10/3_Scriptassertion.png)
