...
date: 2020-11-25 14:19:34 +1100
comments: true
categories: [Cypress, XHR]
keywords: [Cypress, XHR]
...
![result]({{site.images_dir}}/2020/11/25/result1.png)
...
![result]({{site.images_dir}}/2020/11/25/stubbed_result.png)
