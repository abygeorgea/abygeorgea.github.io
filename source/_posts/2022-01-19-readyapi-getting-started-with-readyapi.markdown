...
date: 2022-01-19 06:44:53 +1000
comments: true
categories: [ReadyAPI, SoapUI]
keywords: [ReadyAPI, SoapUI]
...
![Result]({{site.images_dir}}/2022/01/19/3.png)

![Result]({{site.images_dir}}/2022/01/19/4.png)
...
![Result]({{site.images_dir}}/2022/01/19/4_1.png)
...
![Result]({{site.images_dir}}/2022/01/19/7.png)
...
* Any test automation is only as good as the assertions added to it. Let us look in detail about the steps to add assertions. Click on the + button on assertions tab. That will provide a list of possible assertion
	...
	* ![Result]({{site.images_dir}}/2022/01/19/8.png)
	
	
	* Contains : This allows to check the response content has a string we specify.
	* ![Result]({{site.images_dir}}/2022/01/19/9.png)
	...
	* ![Result]({{site.images_dir}}/2022/01/19/10.png)
